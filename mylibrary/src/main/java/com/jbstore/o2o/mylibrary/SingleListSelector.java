...
public class SingleListSelector {
    Activity mContext;
    Button sure, cancel;
    Dialog dialog;
    SingleListSelectView selectView;
    List str = new ArrayList<>();

    public SingleListSelector(Activity mContext, List str) {
...
//        initView(layId);
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.singlistselector, null);
